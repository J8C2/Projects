...
public class Blocks implements Comparable<Blocks>
{
	...
	public static ArrayList<String> uniqMiners;
	public static ArrayList<Integer> uniqMinersFreq;
	...
	{	
	    ...
	    uniqMiners = new ArrayList<String>();
		uniqMinersFreq = new ArrayList<Integer>();
